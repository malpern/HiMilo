...
enum AccessibilityID {
    ...
    enum Settings {
        ...
        static let apiKeyDisplay = "settings.apiKeyDisplay"
        static let apiKeySheetCancel = "settings.apiKeySheetCancel"
        static let apiKeySheetSave = "settings.apiKeySheetSave"
        static let elevenLabsVoicePicker = "settings.elevenLabsVoicePicker"
        static let elevenLabsApiKeyField = "settings.elevenLabsApiKeyField"
        static let removeElevenLabsAPIKey = "settings.removeElevenLabsAPIKey"
